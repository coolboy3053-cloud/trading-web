    ...
    return (
        <nav className={styles.navbar}>
            <div className={styles.container}>
                ...
                <div className={`${styles.navLinks} ${isOpen ? styles.active : ''}`} id="primary-navigation">
                    ...
                    <button className={styles.langBtn} onClick={switchLanguage} aria-label={t('nav.switchLanguage')}>
                        {language === 'zh' ? 'EN' : '中文'}
                    </button>
